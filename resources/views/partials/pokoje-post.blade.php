...
<div class="grid grid-cols-12 gap-6 my-10">
    ...
    <div class="col-span-12 lg:col-span-4 galleryPokoje flex justify-center">
        <div class="max-lg:max-w-[360px] max-xs:max-w-full max-w-full">
            ...
            <div class="swiper gallery-thumbs mt-4 xs:mt-6">
                <div class="swiper-wrapper">
                    @if (has_post_thumbnail())
    ...
    <div class="col-span-full lg:col-span-8">
        <div class="box shadow-cien-1 p-6 rounded-3xl">
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-center max-lg:text-center lg:justify-between flex-wrap">
                    <div class="text-h3 font-primary">
                        <h2>@title</h2>
                    </div>
                    @if ($price)
                    <div class="price text-B12">
                ...
                @endif
                <div class="additional flex flex-col gap-2">
                    @if ($size)
                    <div class="size">
                ...
                <div class="inline-flex mt-8 w-full justify-end">
