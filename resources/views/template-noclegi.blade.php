...
@endif
@if ($shortcode)
<section class="contact__form mt-72 pb-72 relative overflow-hidden" id="form">
  <div class="container">
    @if ($title)
      <div class="col-span-full mb-8 text-center text-h2 font-primary">
        <h2>{!! $title !!}</h2>
      </div>
    @endif
      <div class="grid grid-cols-12 gap-6 relative">
          <div class="lg:w-[calc((648/1128)*100%)] lg:absolute relative w-full flex items-center justify-center max-lg:col-span-full">
